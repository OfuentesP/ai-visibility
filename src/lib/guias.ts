...
export const guias: Guia[] = [
  {
    ...
    descripcion:
      'El CyberDay 2026 (1–3 de junio) se gana en ChatGPT la semana antes, no en tu landing de descuentos. Guía práctica para emprendedores y tiendas online que quieren aparecer en las respuestas de Ai cuando sus clientes validan la compra.',
    fecha: '2026-05-14',
    ...
    secciones: [
      {
        ...
        parrafos: [
          ...
          'En esa ventana, la Ai actúa como un consejero de compra que sintetiza reseñas, historial de precios y reputación de marca. Si no estás en esa síntesis, no entras al proceso de decisión. El cliente llega a tu competidor con la decisión tomada.',
        ],
      },
      {
      ...
      {
        h2: 'Los 3 errores que hacen invisible tu tienda en la Ai',
        parrafos: [
        ...
        lista: [
          ...
          'Sin menciones en medios de nicho: Un artículo en un blog de tecnología chilena, una mención en un medio de consumidores o una nota en La Tercera Tendencias vale más para la Ai que 50 posts en Instagram.',
        ],
      },
      {
        ...
        lista: [
          ...
          'Consigue 5 reseñas nuevas en Google esta semana: Escríbele a tus últimos 20 clientes satisfechos. Una tasa de respuesta del 25% ya te da el volumen necesario para que la Ai tenga señales de confianza actualizadas.',
      ...
      },
      {
        ...
        parrafos: [
          ...
          'La estrategia correcta para una pyme o emprendimiento en CyberDay no es competir con Falabella en las queries genéricas. Es dominar el nicho donde tienes ventaja real, y hacer que la Ai lo sepa.',
        ],
      },
    ],
    faq: [
