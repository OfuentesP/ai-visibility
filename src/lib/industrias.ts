...
export const industrias: Industria[] = [
  {
    ...
    lecturas: [
      ...
      { slug: 'guia-google-ia-acciones-marca-chilena', titulo: 'La guía de Google para búsqueda con Ai, traducida a acciones para una marca chilena' },
    ],
    ...
    dolores: [
      {
        ...
        desc: 'El 67% de los compradores B2B ya investigó con Ai antes de su primera llamada con ventas. Si ChatGPT no te menciona en esa fase, no entras al shortlist.',
      },
      {
      ...
      {
        titulo: 'Las reseñas en G2 y Capterra alimentan a la Ai',
    ...
    faq: [
      ...
      {
        q: '¿Cómo compito con Salesforce en las respuestas de Ai?',
      ...
      },
      {
        ...
        a: 'Es donde más impacto tiene. En ventas enterprise con múltiples stakeholders, cada evaluador hace sus propias consultas a la Ai. Aparecer en cada una de esas consultas es equivalente a tener un SDR trabajando en cada cuenta, 24/7.',
      },
    ],
  },
  {
    ...
    lecturas: [
      ...
      { slug: 'ecommerce-chileno-busqueda-ia-cyberday-2026', titulo: 'El e-commerce chileno frente a la búsqueda con Ai: qué hacer antes del CyberDay 2026' },
    ...
    descripcion:
      'ChatGPT ya reemplaza a Google para comparar tiendas y productos. Cuando alguien pregunta dónde comprar, la Ai da una sola respuesta — o eres tú, o es tu competencia.',
    queries: [
    ...
    dolores: [
      {
        titulo: 'La Ai valida la confianza antes que tú puedas hablar',
        desc: 'Antes de ingresar a tu sitio, el comprador le preguntó a ChatGPT si tu tienda es confiable. Si la Ai no tiene datos estructurados de tus reseñas y políticas, la respuesta será genérica — o peor, mencionará a tu competidor.',
      },
      {
        titulo: 'El SEO de producto no funciona en Ai',
        desc: 'Rankear en Google para "zapatillas running baratas" no garantiza que ChatGPT te recomiende. La Ai sintetiza una respuesta basada en reputación y autoridad de fuentes — no en keywords ni meta tags.',
      },
      {
    ...
    faq: [
      {
        ...
        a: 'Sí. Las consultas de Ai locales ("mejor tienda de muebles en Providencia") están creciendo más rápido que las genéricas. JSON-LD de tipo LocalBusiness con horarios, dirección y reseñas es el punto de partida para retail con presencia física.',
      },
      {
        q: '¿Qué tan importante son las reseñas para el GEO en retail?',
        a: 'Críticas. Perplexity cita Google Reviews, Trustpilot y foros chilenos (Reclamos.cl) como señal de confianza. Una tienda con 4.5+ estrellas en fuentes indexadas tiene una ventaja estructural en las respuestas de Ai sobre recomendaciones de compra.',
      },
      {
  ...
  },
  {
    ...
    dolores: [
      {
        titulo: 'La decisión de salud ya se toma con Ai',
      ...
      },
      {
        ...
        desc: 'Si los LLMs no tienen datos estructurados precisos sobre tus especialidades, médicos y coberturas, pueden generar respuestas incorrectas (alucinaciones). Un paciente mal informado por la Ai es un riesgo clínico y reputacional.',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'El GEO no expone datos de pacientes — trabaja sobre información pública de tu clínica: especialidades, médicos, tecnología disponible, coberturas de seguros y reseñas. Es información que ya debería estar en tu sitio, solo estructurada para que la Ai pueda leerla correctamente.',
      },
      {
  ...
  },
  {
    ...
    dolores: [
      {
        titulo: 'La comparación de productos financieros ya es tarea de la Ai',
      ...
      },
      {
        ...
        desc: 'BCI, Santander y Scotiabank tienen miles de artículos, comunicados y reseñas indexadas. Las instituciones medianas y fintechs pierden visibilidad generativa aunque tengan mejores productos — porque la Ai no los conoce suficientemente.',
      },
      {
        titulo: 'La confianza regulatoria debe quedar explícita para la Ai',
        desc: 'ChatGPT no sabe que tu institución está regulada por la CMF a menos que lo declares en datos estructurados. Sin esa señal, la Ai puede omitirte o no validar tu credibilidad frente a alternativas más conocidas.',
      },
    ],
    faq: [
      {
  ...
  },
  {
    ...
    lecturas: [
      ...
      { slug: 'jsonld-organization-chile', titulo: 'JSON-LD Organization para marcas chilenas: plantilla lista para copiar' },
      { slug: 'contenido-commodity-vs-experiencia-real-ia', titulo: 'Contenido commodity vs. experiencia real: qué premia la Ai según Google' },
    ],
    nombre: 'Pymes & Emprendimientos',
    tagline: 'GEO para Pymes en Chile',
    descripcion:
      'Las pymes chilenas compiten contra grandes marcas en las respuestas de ChatGPT sin saberlo. Quien estructure primero su información para la Ai, gana el canal generativo completo.',
    queries: [
    ...
    dolores: [
      {
        titulo: 'Las grandes empresas acaparan las respuestas de Ai',
      ...
      {
        titulo: 'El boca a boca ya no llega a la Ai',
        desc: 'Una pyme puede tener excelente reputación en su red de contactos, pero si esa reputación no está en fuentes que los LLMs indexan (reseñas de Google, foros, medios), la Ai no puede recomendarla — y el canal generativo le pertenece a quien sí lo tenga documentado.',
      },
      {
    ...
    faq: [
      ...
      {
        q: '¿Puede una pyme competir con Falabella o Sodimac en las respuestas de Ai?',
  ...
  },
  {
    ...
    dolores: [
      ...
      {
        titulo: 'La Ai opina sobre comunas y valores — con o sin tu marca',
        desc: 'ChatGPT responde preguntas sobre dónde vivir, qué comunas están en alza y qué inmobiliarias son confiables. Si no tienes datos estructurados que la Ai pueda usar para validarte, esa conversación la gana quien sí los tenga.',
      },
      {
    ...
    faq: [
      ...
      {
        q: '¿Cómo afecta la tasa de interés y el contexto macro a las respuestas de Ai?',
        a: 'Los LLMs con acceso web actualizan su contexto económico con noticias recientes. Si tu inmobiliaria tiene contenido publicado sobre el impacto de la tasa en el mercado chileno, la Ai te puede citar como fuente de autoridad en esas consultas — que tienen altísimo volumen en períodos de incertidumbre.',
      },
      {
  ...
  },
  {
    ...
    descripcion:
      'Tu tienda online compite en dos frentes: Google y ChatGPT. El segundo ya decide si tu marca es confiable antes de que el cliente vea tu precio. Sin visibilidad en Ai, el tráfico llega — pero la confianza no.',
    queries: [
    ...
    dolores: [
      {
        ...
        desc: 'Antes de ver tu landing de oferta, el comprador le preguntó a ChatGPT si tu tienda es confiable. Si la Ai no tiene datos estructurados de reseñas, políticas de devolución y autoridad de marca, la respuesta es genérica — o menciona a otro.',
      },
      {
        titulo: 'Tiendanube y Shopify no te posicionan en Ai por defecto',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'En e-commerce puro, el 100% del ciclo de compra ocurre en pantalla, lo que hace que la validación de confianza en Ai sea más crítica. No hay vendedor que rescate la duda. El JSON-LD y las reseñas en plataformas indexadas son tu único equipo de ventas antes del primer clic.',
      },
      {
        q: '¿Sirve para marcas que venden en Mercado Libre o Amazon además de su propia tienda?',
        a: 'Sí, y ahí hay una ventaja táctica: Mercado Libre y Amazon ya están indexados con alta autoridad en los LLMs. Si tu marca tiene un perfil de vendedor bien calificado en esas plataformas, la Ai puede citarlas como señal de confianza aunque tu sitio propio tenga poco histórico.',
      },
    ],
  },
  {
    ...
    descripcion:
      'El CyberDay 2026 es el 1 al 3 de junio. La decisión de compra empieza en ChatGPT días antes — no en tu landing de descuentos. Si la Ai no recomienda tu tienda cuando preguntan, el esfuerzo de preparación llega tarde.',
    queries: [
    ...
    dolores: [
      {
        ...
        desc: 'Los compradores que investigan antes del CyberDay le preguntan a la Ai qué tiendas son confiables y cuáles tienen historial de inflar precios. Si tu marca no aparece en esa respuesta — o aparece con dudas — el precio deja de ser el factor.',
      },
      {
        titulo: 'Falabella, Paris y Ripley dominan las respuestas de Ai sin hacer nada',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Es donde más impacto tiene. Las tiendas nuevas no tienen historial de precios que la Ai pueda consultar, pero sí pueden construir una señal de confianza rápida: reseñas en Google, JSON-LD de tipo Store y una o dos menciones en blogs o medios de nicho. Eso puede ser suficiente para aparecer en las respuestas junto a marcas con más años.',
      },
    ],
  },
]
