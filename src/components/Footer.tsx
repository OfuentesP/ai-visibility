      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-slate-500 text-sm sm:text-xs leading-relaxed max-w-xs">
            ...
            <p className="text-slate-700 text-sm sm:text-xs mt-3 leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/auditar/banca/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">GEO para Banca</Link></li>
              <li><Link href="/auditar/pyme/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">GEO para Pymes</Link></li>
              <li><Link href="/auditar/inmobiliaria/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">GEO para Inmobiliaria</Link></li>
            </ul>
          </div>

          {/* Glosario */}
          <div>
            <p className="text-xs sm:text-[10px] font-mono text-slate-500 uppercase tracking-widest mb-3">Glosario GEO</p>
            <ul className="space-y-2">
              <li><Link href="/glosario/geo/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">Generative Engine Optimization</Link></li>
              <li><Link href="/glosario/share-of-model/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">Share of Model (SoM)</Link></li>
              <li><Link href="/glosario/aeo/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">Answer Engine Optimization</Link></li>
              <li><Link href="/glosario/seo/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">SEO vs GEO</Link></li>
              <li><Link href="/glosario/rag/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">RAG</Link></li>
              <li><Link href="/glosario/llm/" className="text-slate-700 text-sm sm:text-xs hover:text-slate-900 transition-colors">LLM</Link></li>
              <li><Link href="/glosario/" className="text-slate-700 text-sm sm:text-xs hover:text-indigo-600 transition-colors">Ver todos →</Link></li>
            </ul>
          </div>
        ...
        {/* Bottom bar */}
        <div className="border-t border-slate-200/40 pt-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <p className="text-slate-500 text-xs sm:text-[11px] font-mono">
          ...
          <div className="flex items-center gap-5">
            ...
            <p className="hidden sm:block text-slate-400 text-xs sm:text-[10px] font-mono">
              GEO · AEO · SoM · RAG · LLM
            </p>
          </div>
        </div>
